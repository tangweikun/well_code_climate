...
export default function CourseReservation(props: any) {
  ...
  const { data: courseList = [], isLoading } = useFetch({
      ...
      >
        <Spin spinning={isLoading}>
          ...
          <div style={{ display: 'flex', margin: '20px 0' }}>
            <div style={{ background: 'lightgray', marginRight: 10, width: 100, textAlign: 'center' }}>未发布</div>
            <div style={{ background: '#63c3a4', marginRight: 10, width: 100, textAlign: 'center' }}>已发布</div>
            <div style={{ background: 'yellow', marginRight: 10, width: 100, textAlign: 'center' }}>已约满</div>
            <div style={{ background: '#d8d8d8', marginRight: 10, width: 100, textAlign: 'center' }}>已过期</div>
