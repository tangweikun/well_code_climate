...
import { useFetch, useTablePagination, useHash } from 'hooks';
...
import SettlementRecordsTable from 'erp/pages/financial/settlementRecords/SettlementRecordsTable';
import TransactionRecordsTable from 'erp/pages/financial/transactionRecords/TransactionRecordsTable';
              ...
              <TabPane tab="交易记录" key="3">
                <TransactionRecordsTable
                  query={{
                    ...
                    transType: '6', // 3:冻结类型交易记录 6:充值类型交易记录
