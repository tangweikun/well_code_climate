...
import InputCardNum from 'erp/pages/student/studentCardMaking/InputCardNum';
import { getCardID, _get } from 'utils';
import Details from 'erp/pages/coach/coachInfo/Details';
...
function CoachCard() {
  ...
  const columns = [
    ...
    { title: '教练状态', dataIndex: 'employstatus', render: (employstatus: any) => employStatusHash[employstatus] },
    ...
    { title: '制卡日期', dataIndex: 'maketime' },
    { title: '当前卡类型', dataIndex: 'usertype', render: (usertype: any) => cardTypeHash[usertype] },
    { title: '有效截止日期', dataIndex: 'validdate' },
  ...
  return (
    <div>
      ...
      {visible && <Details onCancel={_switchVisible} currentId={currentId} />}
