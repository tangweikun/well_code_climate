    ...
    <Modal
      ...
      onOk={() => {
        form.validateFields().then(async (values) => {
          if (_get(values, 'traincode').length < 1) {
            message.error('请选择可培训类型');
            return;
          }
          const query = {
            sbnid,
    ...
    >
      <Form
        ...
        initialValues={{
          ...
          traincode: _get(currentRecord, 'traincode') ? _get(currentRecord, 'traincode').split(',') : [],
      ...
      >
        ...
        <Form.Item label="可培训类型" name="traincode">
          <Checkbox.Group>
            <Checkbox value="3">模拟</Checkbox>
            <Checkbox value="2">理论</Checkbox>
          </Checkbox.Group>
        </Form.Item>
