...
import { Table, Button, Row, Col, Tooltip, Alert } from 'antd';
...
export default function ConfigCoach(props: any) {
  ...
  const { data, isLoading } = useFetch({
    query: {
      ...
      traincode: '2', //1-实操，2-课堂理论教学，3-模拟教学，4-远程教学
    },
  ...
  return (
    <>
      <div style={{ width: 1300, overflow: 'auto' }}>
        <Row style={{ display: 'flex', justifyContent: 'space-around', width: 1800 }}>
          <Col span={10}>
            <div
              style={{
                fontSize: 18,
      ...
      <Row justify="end">
        ...
        <Button
          ...
          onClick={async () => {
            ...
            run({ associatedCompanyDtos, sbnid: currentId, traincode: '2' });
          }}
        >
          确定
        </Button>
