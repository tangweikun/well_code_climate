...
import TeachingJournalTable from 'erp/pages/student/teachingJournal/teachingJournalTable';
import Minutes from 'erp/pages/student/teachingJournal/Minutes';
  ...
  return (
    <>
      ...
      <div style={{ width: '100%', height: '100%', display: 'flex' }}>
        ...
        <div style={{ flex: 1, marginLeft: 10, padding: 10, border: '1px solid #f0f0f0', borderRadius: '4px 4px 0 0' }}>
          <Tabs
            defaultActiveKey="1"
            onChange={(active) => {
              if (String(active) === '1') {
