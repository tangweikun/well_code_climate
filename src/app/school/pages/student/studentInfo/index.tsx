          ...
          <>
            ...
            {_get(record, 'package_name') && (
              <>
                ...
                {/* status 报名，1学驾驶中 ，bankaccountflag：0 未开户,stuchargemode: 1-托管一次性 缴费  2-托管分批缴费 3-单笔冻结 5- 多笔冻结 */}
                {(_get(record, 'status') === '00' || _get(record, 'status') === '01') &&
                ...
                {/* statu：0 报名，1学驾驶中 ，bankaccountflag：1未开户 , ispay:0 未支付 为在报名或学驾中且未开户和未支付的学员开通充值功能*/}
                {(_get(record, 'status') === '00' || _get(record, 'status') === '01') &&
