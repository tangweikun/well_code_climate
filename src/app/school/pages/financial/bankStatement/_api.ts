...
export async function _getInfo(query: { page: number; limit: number; begin: string; end: string }) {
  return await request(`${CORE_PREFIX}/v1/schReconciliation/page`, 'GET', query);
}
